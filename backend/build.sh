...
zip -g function.zip post_stock.py delete_stock.py get_stocks.py  get_stock_info.py
...
aws lambda update-function-code --function-name get_stock_info --zip-file fileb://function.zip